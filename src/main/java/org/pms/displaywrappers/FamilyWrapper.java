...
public class FamilyWrapper implements GridRow {
    ...
    private String[] VALID_BEAN_PROPERTIES = {"familyNo", "familyName", "massCentreNumber", "massCentreName", "prayerUnitNumber", "prayerUnitName", "parishInNative", "dioceseInNative", "dateOfRegistration", "localAddress.addressLineOne", "localAddress.addressLineTwo", "localAddress.addressLineThree", "localAddress.town", "localAddress.county", "localAddress.pin", "localAddress.country", "nativeAddress.addressLineOne", "nativeAddress.addressLineTwo", "nativeAddress.addressLineThree", "nativeAddress.postOffice", "nativeAddress.district", "nativeAddress.pin", "nativeAddress.state", "nativeAddress.country", "id", "familyPrayerUnit.mappedMassCentre.id", "familyPrayerUnit.id", "emergencyContact.nameAddress", "emergencyContact.phoneNo", "emergencyContact.alternativePhoneNo", "emergencyContact.email", "mobileNo"};
