...
public class UserWrapper implements GridRow {
    ...
    private String[] VALID_BEAN_PROPERTIES = {"email", "systemRoleAsDisplayValue", "isActive", "massCentre", "prayerUnit", "family", "sendMailFlag", "alreadyLoggedIn", "isValidated", "createdBy", "massCentreId", "prayerUnitId", "familyId","id"};
