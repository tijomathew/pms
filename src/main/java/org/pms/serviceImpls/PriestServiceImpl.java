    ...
    public List<PriestDto> createPriestDto(List<Priest> allPriests) throws IllegalArgumentException {
        ...
        if (!allPriests.isEmpty()) {
            ...
            for (Priest priest : allPriests) {
                ...
                priestDto.setIrelandAddress(DisplayUtils.getEmbeddedObjectPropertyValueAsSingleString(priest.getLocalAddress(), "addressLineOne", "addressLineTwo", "addressLineThree", "town", "county", "pin", "country"));
                priestDto.setIndiaAddress(DisplayUtils.getEmbeddedObjectPropertyValueAsSingleString(priest.getNativeAddress(), "addressLineOne", "addressLineTwo", "addressLineThree", "postOffice", "district", "pin", "state", "country"));
                priestDto.setEmergencyContact(DisplayUtils.getEmbeddedObjectPropertyValueAsSingleString(priest.getEmergencyContact(), "name", "addressLineOne", "addressLineTwo", "addressLineThree", "mobileNo", "landLineNo", "email"));
