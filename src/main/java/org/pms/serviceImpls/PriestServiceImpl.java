    ...
    public List<PriestDto> createPriestDto(List<Priest> allPriests) throws IllegalArgumentException {
        ...
        if (!allPriests.isEmpty()) {
            ...
            for (Priest priest : allPriests) {
                ...
                priestDto.setIrelandAddress(DisplayUtils.getEmbeddedObjectPropertyValueAsSingleString(priest.getLocalAddress(), 7, "addressLineOne", "addressLineTwo", "addressLineThree", "town", "county", "pin", "country"));
                priestDto.setIndiaAddress(DisplayUtils.getEmbeddedObjectPropertyValueAsSingleString(priest.getNativeAddress(),8 , "addressLineOne", "addressLineTwo", "addressLineThree", "postOffice", "district", "pin", "state", "country"));
