...
import org.pms.common.PMSApplicationBuilder;
...
public class CustomLoggerAspect {
    ...
    @AfterReturning("execution(* org.pms.user.LoginController.verifyUser(..))")
    ...
    @Before("execution(* org.pms.user.LogoutController.loginPageDisplay(..))")
