 ...
 */
@Component
public class RequestResponseHolderImpl extends ServletRequestAttributes implements RequestResponseHolder {
    ...
    @Autowired
    public RequestResponseHolderImpl(HttpServletRequest httpServletRequest) {
