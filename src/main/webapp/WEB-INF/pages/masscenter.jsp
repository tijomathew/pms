                                                ...
                                                <div class="panel panel-grape">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="name"  class="col-sm-1 control-label">Mass Center Name</label>
                                                            <div class="col-sm-3">
                                                                <form:input path="name" id="name" class="form-control"/>
                                                            </div>
                                                            <label for="centerCode"  class="col-sm-1 control-label">Mass Center Code</label>
                                                            <div class="col-sm-3">
                                                                <form:input path="centerCode" id="centerCode" class="form-control"/>
                                                            </div>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="massCenterID"  class="col-sm-1 control-label">Mass Center ID</label>
                                                            <div class="col-sm-3">
                                                                <form:input path="massCenterID" id="massCenterID" readonly="true" class="form-control"/>
                                                            </div>
                                                            <label for="place"  class="col-sm-1 control-label">Mass Center Place</label>
                                                            <div class="col-sm-3">
                                                                <form:input path="place" id="place" class="form-control"/>
                                                            </div>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="patronName"  class="col-sm-1 control-label">Patron Name</label>
                                                            <div class="col-sm-3">
                                                                <form:input path="patronName" id="patronName" class="form-control"/>
                                                            </div>
                                                            <label for="landLineNo"  class="col-sm-1 control-label">Mass Center Land Line No.</label>
                                                            <div class="col-sm-3">
                                                                <form:input path="landLineNo" id="landLineNo" class="form-control"/>
                                                            </div>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="mobileNo"  class="col-sm-1 control-label">Mass Center Mobile No.</label>
                                                            <div class="col-sm-3">
                                                                <form:input path="mobileNo" id="mobileNo" class="form-control"/>
                                                            </div>
                                                            <label for="email"  class="col-sm-1 control-label">Mass Center Email</label>
                                                            <div class="col-sm-3">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="faxNo"  class="col-sm-1 control-label">Mass Center Fax No.</label>
                                                            <div class="col-sm-3">
                                                                <form:input path="faxNo" id="faxNo" class="form-control"/>
                                                            </div>
                                                            <label for="landLineNo"  class="col-sm-1 control-label">Facebook Page</label>
                                                            <div class="col-sm-3">
                                                                <form:input path="facebookPage" id="facebookPage" class="form-control"/>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <form:input path="registeredDate" id="registeredDate" class="form-control"/>
                                                            </div>
                                                            <label for="drivingRoute"  class="col-sm-1 control-label">Driving Route</label>
                                                            <div class="col-sm-3">
                                                                <form:input path="drivingRoute" id="drivingRoute" class="form-control"/>
                                                            </div>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="map"  class="col-sm-1 control-label">Map</label>
                                                            <div class="col-sm-3">
                                                                <form:input path="map" id="map" class="form-control"/>
                                                            </div>
                                                            <label for="drivingRoute"  class="col-sm-1 control-label">Parish</label>
                                                            <div class="col-sm-3">
                                                                <form:select path="parish" items="${parishList}" id="parishSelectBox" class="form-control"/>
                                                            </div>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="map"  class="col-sm-1 control-label">Priest</label>
                                                            <div class="col-sm-3">
                                                ...
                                                <div class="panel panel-grape">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <label for="localAddress.addressLineTwo"  class="col-sm-1 control-label">Town</label>
                                                            <div class="col-sm-3">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="localAddress.addressLineThree"  class="col-sm-1 control-label">County</label>
                                                            <div class="col-sm-3">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="localAddress.addressLineThree"  class="col-sm-1 control-label">Country</label>
                                                            <div class="col-sm-3">
