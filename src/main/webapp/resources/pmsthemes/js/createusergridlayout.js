    ...
    jQuery("#userGrid").jqGrid(
        {
            ...
            datatype: 'json',
            //rowList: [10, 20, 30],
            colNames: ['Email', 'Role', 'Active', 'Parish', 'Prayer Unit', 'Family', 'Email Sent', 'Already Logged In', 'Validated', 'Created By', 'usersOfParish', 'usersOfPrayerUnits', 'userOfFamily','id'],
            colModel: [
                ...
                {name: 'usersOfParish', index: 'usersOfParish', width: 100, sortable: false, hidden: true},
