    ...
    jQuery("#massCenterGrid").jqGrid(
        {
            ...
            datatype: 'json',
            //rowList: [2, 4, 6],
            colNames: ['Mass Center No.', 'place', 'patronName', 'Parish', 'Parish No.', 'Mass Center Name', 'facebookPage', 'registeredDate', 'drivingRoute', 'map', 'landLineNo', 'mobileNo', 'email', 'faxNo',
            ...
            colModel: [
                ...
                {name: 'massCenterName', index: 'massCenterName', width: 90, sortable: false, hidden: true},
